<?php 
$mensaje = "prueba";
//$destinatario = "ltorres@cuentadealtocosto.org";
...
<body>
  <div class='container'>
    <div class='bg-dark'>
      ...
      <div class='texto'>
        <p>
        La persona : <strong>{$nombrePersona}</strong>.
        La entidad : <strong>{$NombreEntidad}</strong>
        Completo el formulario correctamente.
        </p>
      </div>        
        </br>
      </div>
