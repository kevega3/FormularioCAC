            ...
            <div class="request requestGestión_datos">
                ...
                <select class="Gestión_datos_maestros" name="<?php echo "GestionDatos". $contador?>" id="<?php echo "GestionDatos". $contador?>" required>
                    ...
                    <?php    
                        ...
                        ?>
                    <select data-placeholder="Seleccione uno o varios"  multiselect-hide-x="true"  multiple class="chosen-select " name="<?php echo "GestionDatos". $contador?>[]"  id="<?php echo "GestionDatos". $contador ?>">
