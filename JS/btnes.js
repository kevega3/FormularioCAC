...
function deleteall() {
    ...
    btn2.classList.add("Remove");
    btn3.classList.add("Remove");

    btn4.classList.add("Remove");
    btn5.classList.add("Remove");
    btn6.classList.add("Remove");
    btn7.classList.add("Remove");

    btn8.classList.add("Remove");
    btn9.classList.add("Remove");
    btn10.classList.add("Remove");
    btn11.classList.add("Remove");

    btn12.classList.add("Remove");
    btn13.classList.add("Remove");
    btn14.classList.add("Remove");
    btn15.classList.add("Remove");
    btn16.classList.add("Remove");
    btn17.classList.add("Remove");
    btn18.classList.add("Remove");


    btn1.classList.remove("NoRemove");
    btn2.classList.remove("NoRemove");
    btn2.classList.remove("NoRemove");
    btn3.classList.remove("NoRemove");

    btn4.classList.remove("NoRemove");
    btn5.classList.remove("NoRemove");
    btn6.classList.remove("NoRemove");
    btn7.classList.remove("NoRemove");

    btn8.classList.remove("NoRemove");
    btn9.classList.remove("NoRemove");
    btn10.classList.remove("NoRemove");
    btn11.classList.remove("NoRemove");

    btn12.classList.remove("NoRemove");
    btn13.classList.remove("NoRemove");
    btn14.classList.remove("NoRemove");
    btn15.classList.remove("NoRemove");
    btn16.classList.remove("NoRemove");
    btn17.classList.remove("NoRemove");
    btn18.classList.remove("NoRemove");
}
